  ...
  def as_indexed_json(options = {})
    {
      ...
      tag_count_organization:   tag_count_organization,
      tag_count_location:   tag_count_location,
      ...
      tag_count_clothes:     tag_count_clothes,
